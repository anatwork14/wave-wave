    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "absolute right-[23px] top-24 bottom-24 w-px border-r-2 border-dotted border-[#F66868]"
                }, void 0, false, {
                    fileName: "[project]/Project_Sudo/wave-wave/src/components/MedicalTerminologyCard/index.tsx",
                    lineNumber: 211,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "absolute right-5 top-24 w-2 h-2 bg-[#F66868] rounded-full"
                }, void 0, false, {
                    fileName: "[project]/Project_Sudo/wave-wave/src/components/MedicalTerminologyCard/index.tsx",
                    lineNumber: 212,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "absolute right-5 bottom-24 w-2 h-2 bg-[#F66868] rounded-full"
                }, void 0, false, {
                    fileName: "[project]/Project_Sudo/wave-wave/src/components/MedicalTerminologyCard/index.tsx",
                    lineNumber: 213,
                    columnNumber: 9
...
function MapPage() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$src$2f$store$2f$useUserStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])(); // MODIFICATION: Add state for lessons, loading, and errors
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // MODIFICATION: Add useEffect to fetch data on component mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MapPage.useEffect": ()=>{
            const fetchSyllabuses = {
                "MapPage.useEffect.fetchSyllabuses": async ()=>{
                    try {
                        setIsLoading(true);
                        const response = await fetch("".concat(("TURBOPACK compile-time value", "http://127.0.0.1:8000"), "/api/syllabuses")); // Calls your backend
                        if (!response.ok) {
                            throw new Error("Failed to fetch data from server");
                        } // The backend returns an object like { syllabuses: [...] }
                        const data = await response.json(); // *** IMPORTANT: Data Transformation *** // Your backend data (SyllabusInfo) must be mapped to your frontend (Lesson)
                        const mappedLessons = data.syllabuses.map({
                            "MapPage.useEffect.fetchSyllabuses.mappedLessons": (syllabus, index)=>{
                                // This is placeholder logic.
                                // Ideally, the user's 'status' (completed, etc.)
                                // should come from a different API call.
                                let status = "upcoming";
                                if (index === 0) status = "in-progress"; // Example: make the first one "in-progress"
                                return {
                                    id: syllabus.id.toString(),
                                    title: syllabus.title,
                                    description: syllabus.description,
                                    // Missing data (we use placeholders or derived values)
                                    status: status,
                                    duration: "".concat(syllabus.lesson_count * 5, " min"),
                                    participants: 0,
                                    // Use static arrays for presentation
                                    color: COLORS[index % COLORS.length],
                                    icon: ICONS[index % ICONS.length],
                                    // Use the real ID for the link
                                    link: "/study/learn/topic/".concat(syllabus.id)
                                };
                            }
                        }["MapPage.useEffect.fetchSyllabuses.mappedLessons"]);
    ...
    }["MapPage.useEffect"], []); // The empty array [] means this runs only once when the component mounts // MODIFICATION: These calculations now depend on the fetched state
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    " ",
                    " ",
                    !isLoading && !error && lessons.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        " ",
                                                        lesson.status === "upcoming" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Project_Sudo$2f$wave$2d$wave$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$square$2d$dashed$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__SquareDashed$3e$__["SquareDashed"], {
                                                            className: "w-4 h-4 text-white"
                                                        }, void 0, false, {
                                                            fileName: "[project]/Project_Sudo/wave-wave/src/app/study/map/page.tsx",
                                                            lineNumber: 177,
...
_s(MapPage, "rvwR8D7oXicXqc9ZCfXqMmUOGk8=", false, function() {
    return [
...
//# sourceMappingURL=Project_Sudo_wave-wave_src_248cbcdd._.js.map